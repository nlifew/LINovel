...
public class HorizontalListView extends RecyclerView {
    ...
    public void commit() {
        ...
        post(() -> {
            if (mAdapter.mDataSet.size() > mAdapter.mCheckedItemPosition * 2
                    && mItemClickListener != null) {
                Object id = mAdapter.mDataSet.get(mAdapter.mCheckedItemPosition * 2 + 1);
                mItemClickListener.onItemSelect(this, id);
            }
        });
    }
