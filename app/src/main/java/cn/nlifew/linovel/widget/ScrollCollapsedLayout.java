...
public class ScrollCollapsedLayout extends CollapsingToolbarLayout {
    ...
    private void updateScrollChild(int l, int t, int r, int b) {
        ...
        if (mToolbar == null) {
            mToolbar = (Toolbar) quietGetObject(sToolBar, this);
            mTmpRect = (Rect) quietGetObject(sTmpRect, this);
        }
        if (mToolbar != null) {
    ...
    private final class AppBarOffsetListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
            ...
            if (mLastInsets == null) {
                mLastInsets = (WindowInsetsCompat) quietGetObject(
                        sLastInsets,
                        ScrollCollapsedLayout.this
                );
            }
    ...
    private static Object quietGetObject(Field field, Object obj) {
        if (field != null) {
            try {
